---
title: "Set-associative caching"
layout: activity
---

From: Guest ()
Date: March 7, 2006, 2:46 pm

Set-Associative Caching

*Comments in this document are in italics (surrounded by forward slashes in the text).  Remove them and replace them with your own content.  (See* [Human Mystery Interface]({{ "/activities/human-mystery-interface/" | relative_url }}) *for a complete example built from this template.)*

*Replace the title with your own.  Start each word with an upper-case letter.*

*Include affiliation and contact info below if you'd like:*

Designed by *Author Name*

*We would like you to lodge a complete description of your KLA.  However, this being a wiki, you should feel free to leave your KLA as a "stub" if necessary: an incomplete page that invites further editing by other wiki users.  If so, please mark it as a stub at the top and put in enough information for others to carry your efforts on.*
